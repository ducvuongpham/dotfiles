# Generated by Powerlevel10k configuration wizard on 2026-05-09 at 13:34 JST.
...
# lightest-ornaments, sparse, concise, transient_prompt, instant_prompt=auto-quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    mise                  # mise active tools (one styled segment per tool)
    # node_version / go_version / rust_version intentionally OFF — the
    # mise segment covers them with per-runtime icons + colors instead.
  ...
  # Box decorations removed — they leave artifacts in scrollback on terminal
  # resize (each WINCH redraws the prompt; old top/bottom line remnants stay).
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      # Styling for up-to-date Git status — catppuccin macchiato.
      local       meta='%f'             # default foreground
      local      clean='%F{#a6da95}'    # green
      local   modified='%F{#eed49f}'    # yellow
      local  untracked='%F{#7dc4e4}'    # sapphire
      local conflicted='%F{#ed8796}'    # red
    else
      # Styling for incomplete / stale Git status — macchiato overlay0 (gray).
      local       meta='%F{#6e738d}'
      local      clean='%F{#6e738d}'
      local   modified='%F{#6e738d}'
      local  untracked='%F{#6e738d}'
      local conflicted='%F{#6e738d}'
    fi
...
# ── Catppuccin macchiato accent overrides (appended) ──────────────────────
# Override common foreground colors with macchiato hex. Last-set wins, so
# this trumps any earlier 256-palette numbers in the file.
typeset -g POWERLEVEL9K_DIR_FOREGROUND='#8aadf4'                                              # blue
typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#a5adcb'                                    # subtext0
...
# Vi NORMAL / VISUAL / OPERATOR-PENDING mode prompt char (❮ / V / etc.) →
# macchiato yellow regardless of last-cmd status, so the mode change is
# visually distinct from insert mode (green).
typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VICMD,VIVIS,VIOWR}_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VICMD,VIVIS,VIOWR}_FOREGROUND='#eed49f'
...
typeset -g POWERLEVEL9K_VCS_LOADING_FOREGROUND='#6e738d'
typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#a6da95'
...
typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND='#a5adcb'
typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#a6da95'
typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_ASDF_FOREGROUND='#8bd5ca'                                             # teal
typeset -g POWERLEVEL9K_RULER_FOREGROUND='#6e738d'
typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND='#cad3f5'                                          # text
typeset -g POWERLEVEL9K_TIME_FOREGROUND='#6e738d'
typeset -g POWERLEVEL9K_BATTERY_LOW_FOREGROUND='#ed8796'
typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND='#a5adcb'
typeset -g POWERLEVEL9K_BATTERY_CHARGING_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_BATTERY_CHARGED_FOREGROUND='#a6da95'
typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND='#7dc4e4'
typeset -g POWERLEVEL9K_NODE_VERSION_FOREGROUND='#a6da95'
typeset -g POWERLEVEL9K_PYTHON_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_GO_VERSION_FOREGROUND='#7dc4e4'
typeset -g POWERLEVEL9K_RUST_VERSION_FOREGROUND='#f5a97f'                                     # peach
typeset -g POWERLEVEL9K_TERRAFORM_FOREGROUND='#c6a0f6'                                        # mauve
typeset -g POWERLEVEL9K_AWS_FOREGROUND='#f5a97f'
typeset -g POWERLEVEL9K_GCLOUD_FOREGROUND='#7dc4e4'
typeset -g POWERLEVEL9K_AZURE_FOREGROUND='#7dc4e4'
typeset -g POWERLEVEL9K_VIRTUALENV_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_PYENV_FOREGROUND='#eed49f'
typeset -g POWERLEVEL9K_NVM_FOREGROUND='#a6da95'
typeset -g POWERLEVEL9K_RANGER_FOREGROUND='#a5adcb'
typeset -g POWERLEVEL9K_NNN_FOREGROUND='#a5adcb'

# ── Custom segment: mise active tools ─────────────────────────────────────
# One p10k segment per tool, with a per-runtime Nerd Font icon + macchiato
# color so it visually matches p10k's native node_version/go_version etc.
